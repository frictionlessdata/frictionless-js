...
describe("Dataset", () => {
    ...
    it("Dataset.load works with co2-ppm", async () => {
        ...
        assert.strictEqual(dataset2.resources[0].path.includes('datajs/test/fixtures/co2-ppm/data/co2-mm-mlo.csv'), true)
        assert.strictEqual(dataset2.readme.includes('CO2 PPM - Trends in Atmospheric Carbon Dioxide.'), true)
    })
    ...
    it("Dataset.load with dir/datapckage.json", async () => {
        ...
        assert.strictEqual(dataset.readme.includes('CO2 PPM - Trends in Atmospheric Carbon Dioxide.'), true)

    })

})

describe("Dataset.nock", async () => {
